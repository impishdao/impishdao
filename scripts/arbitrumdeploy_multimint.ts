...
async function main() {
  ...
  // Verified contract on Arbitrum
  // https://arbiscan.io/address/0x75ae378320e1cde25a496dfa22972d253fc2270f
  const IMPISHMARKET_address = "0x75ae378320e1cde25a496dfa22972d253fc2270f";

  const multimint = await MultiMint.deploy(IMPISHSPIRALS_address);
