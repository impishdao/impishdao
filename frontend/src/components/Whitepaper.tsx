    ...
    return (
        <Row className="justify-content-md-center">
            <Col md={6}>
                ...
                <div className="mb-3">
                    <span style={{fontWeight: 'bold', color: '#ffd454'}}>How will ImpishDAO win the prize?</span><br/>
                    ImpishDAO aims to pool funds from users and buy the RandomWalkNFTs with the goal of being the last minter. All funds contributed to ImpishDAO
                    are held in the ImpishDAO contract and are used to buy RandomWalkNFTs. If someone else mints a RandomWalkNFT and becomes the last minter 
                    (thereby outbidding us), ImpishDAO will try to raise more funds and buy the next RandomWalkNFT, thereby becoming the last minter again. 
                </div>

                <div className="mb-3">
                    <span style={{fontWeight: 'bold', color: '#ffd454'}}>What is the IMPISH token?</span><br/>
                    When you contribute funds to the ImpishDAO, you are issued IMPISH tokens to represent your share of the ImpishDAO. These are standard ERC20 tokens, 
                    so you can use them just like you would any other token. The IMPISH tokens are issued at the ratio of 1 ETH = 1000 IMPISH.
                    <br/><br/>
                ...
                <div className="mb-3">
                    <span style={{fontWeight: 'bold', color: '#ffd454'}}>How much can I contribute?</span><br/>
                    To safeguard against any bugs in the smartcontract, ImpishDAO limits the amount of ETH it holds at any time to approximately 10 times the price of the 
                ...
                <div className="mb-3">
                    <span style={{fontWeight: 'bold', color: '#ffd454'}}>What are the fees? How will the developers make money?</span><br/>
                    There are no developer or royalty fees to use ImpishDAO (Apart from gas costs). 
                    <br/><br/>
                    The developers are in the same boat as the other members of the ImpishDAO. The developers plan to contribute to the DAO, holding the IMPISH tokens,
                    and hope to win the prize. Note that there are no advantages to mint early in the ImpishDAO, since the winnings are distributed in proportion of
                    IMPISH tokens, which are minted at a fixed price of 1 ETH = 1000 IMPISH tokens. 
                </div>
                ...
                <div className="mb-3">
                    ...
                    <br/><br/>
                    The smart contract is not upgradable, and the developers have no way to access the funds in the smart contract. The only thing the funds can be used
                    for is to buy RandomWalkNFTs. 
                </div>
            </Col>
        </Row>
    )
